...
## Remove K6 outlier row, as it causes errors
```{r}
K6_matrix <- readLines(here::here("data", "star", "K6", "Solo.out", "SJ", "raw", "matrix.mtx"))
...
writeLines(K6_matrix_fixed, here::here("data", "star", "K6", "Solo.out", "SJ", "raw", "matrix_fixed.mtx"))
```
...
# sample K1
K1_sj_info <- split_sj_info_ts(
  sample_id = "K1",
  condition = "WT"
)
# sample K2
K2_sj_info <- split_sj_info_ts(
  sample_id = "K2",
  condition = "S858R"
)
# sample K3
K3_sj_info <- split_sj_info_ts(
  sample_id = "K3",
  condition = "WT"
)
# sample K4
K4_sj_info <- split_sj_info_ts(
  sample_id = "K4",
  condition = "S858R"
)
# sample K5
K5_sj_info <- split_sj_info_ts(
  sample_id = "K5",
  condition = "WT"
)
# sample K6
