...
The purpose of this script is to get CV of the numbers of splice junctions detected for each cell. We can use the metadata to get this information. THIS SCRIPT IS NOW ARCHIVED.
