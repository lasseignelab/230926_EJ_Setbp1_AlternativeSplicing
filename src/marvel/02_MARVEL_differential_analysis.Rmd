...
index <-
  which(sample_metadata$cell_type == "Excitatory Neurons" &
          sample_metadata$seq_folder == "widtype")
...
Saving and loading the objects takes tons of extra time, and for looking at specific aspects it is more convenient to just pull the significant gene and SJ info into an easily readable table, instead of 266 GB of objects.
...
Plot UMAPS for excitatory genes with custom function. Note: Might remove this code later?
...
Also can do for other cell types.
