...
source(here::here("src", "functions_soelter.R"))
```
...
# arrange panels
figure_2 <- plot_grid(gene_expr_vln, delta_sj_expr_usage_heatmaps,
  labels = c("", "C"), nrow = 1
)
...
filepath <- here::here("results", "as_gene_summaries", "brain")
