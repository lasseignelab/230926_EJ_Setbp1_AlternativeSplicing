...
The point of this figure is to convey the important of the Son gene and also add an additional panel to show where the splice junctions lit on transcript structures.
...
son_202_plot <- son_202_exons %>%
  ...
  geom_junction_label_repel(
    data = gene_junctions,
    aes(label = sj_1_2_labs), junction.y.max = 0.5
    #,segment.color = NA
  ) +
   theme_minimal() +
  theme(
...
# arrange vln plot
gene_expr_vln <- plot_grid(son_202_plot, split_violin,
  ncol = 1,
  labels = c("B", "C")
)
