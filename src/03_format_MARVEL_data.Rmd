...
# Make list of all matrices
matrices <- list(J1_sj_info, J2_sj_info, J3_sj_info, J4_sj_info, J13_sj_info, J15_sj_info)
...
align_matrix <- function(mat, all_features) {
  ...
  aligned_mat <- sparseMatrix(i = numeric(0), j = numeric(0), repr = "T",
...
The default repr = "C" created a ngCMatrix which made values logical. Going to try running this as repr = "T" to hopefully fix, but I have to go home then on vacation so hopefully my notes make enough sense when I get back in Jan!
