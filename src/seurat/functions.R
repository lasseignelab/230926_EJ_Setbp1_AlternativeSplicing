...
# https://www.biorxiv.org/content/10.1101/2023.11.29.569304v1
...
calculate_qc <- function(seurat_object) {
  seurat_object$log10GenesPerUMI <-
    log10(seurat_object$nFeature_RNA) / log10(seurat_object$nCount_RNA)
...
# A function which takes seurat metadata and plots quality control metrics for
# filtering purposes
plot_qc <- function(metadata) {
  ...
  # Visualize mitochondrial gene expression detected per cell
...
## convert_human_gene_list - modified by EJ
# Source: https://www.r-bloggers.com/2016/10/converting-mouse-to-human-gene-names-with-biomart-package/
# Names of variables changed for clarity and fit style guidelines,
# host changed to 2021 archive to fix error
...
# A function which finds clusters for a Seurat Object at user determined
# resolutions
