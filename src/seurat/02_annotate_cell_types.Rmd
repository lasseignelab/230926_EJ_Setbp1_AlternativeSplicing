...
The purpose of this script is to annotate cell types using seurat. It is dependent on script 01. Please use docker image setbp1_alternative_splicing:1.0.4 or above.
